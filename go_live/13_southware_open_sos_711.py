...
def read_transform(date_time, relations_dict, onedrive_path):
    df = pd.read_excel(
        onedrive_path + "Complete Master/SLSORDRH01-SAC-01-30-2023-939am.xlsx")
    print(df)
    # Order Type = R
    # Order Type = D
    # Order Type = Q
    ...
    df.to_excel(onedrive_path + "Download Southware/open_sos_headers_output_quotes_" +
