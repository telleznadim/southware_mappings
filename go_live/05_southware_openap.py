...
def read_transform(onedrive_path):
    df = pd.read_excel(
        onedrive_path + "Complete Master/OPENAP01-SAC-01-26-2023-1149AM.xlsx")
    # df = df[df["Current"] != 0]
    print(df)
...
onedrive_path = "/Users/nadimtellezbarrera/Library/CloudStorage/OneDrive-EVI/07-SAC/Go Live/4. Open AP/"
