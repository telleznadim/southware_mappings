...
def read_transform(date_time, relations_dict, onedrive_path, sos_headers_filename):
    df = pd.read_excel(
        f'{onedrive_path}Complete Master/{sos_headers_filename}.xlsx')
    print(df)
...
def main():
    ...
    read_transform(date_time, relations_dict,
                   onedrive_path, sos_headers_filename)
