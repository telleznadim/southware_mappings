...
def read_transform(date_time, relations_dict, onedrive_path):
    df = pd.read_excel(
        onedrive_path + "Complete Master/OPENAR01-SAC-01-09-2023.xlsx")
    # df = df[df["CURRENT"] != 0]
    print(df)
...
def main():
    ...
    onedrive_path = "/Users/nadimtellezbarrera/Library/CloudStorage/OneDrive-EVI/07-SAC/Go Live Simluation 01.06.2023/5. Open AR/"
